...
EXAMPLES = r"""
- name: Create or modify the authentication flow.
  community.general.keycloak_authentication_v2:
    ...
    authenticationExecutions:
      ...
      - subFlow: "test-subflow1"
        requirement: "ALTERNATIVE"
        authenticationExecutions:
          - providerId: "subflow1-test-execution1"
            requirement: "REQUIRED"
          - providerId: "subflow1-test-execution2"
            requirement: "REQUIRED"
      - subFlow: "test-subflow2"
        requirement: "ALTERNATIVE"
        authenticationExecutions:
          - providerId: "subflow2-test-execution1"
            requirement: "REQUIRED"
          - providerId: "subflow2-test-execution2"
            requirement: "REQUIRED"
      - providerId: "test-execution3"
        requirement: "REQUIRED"
    state: present
